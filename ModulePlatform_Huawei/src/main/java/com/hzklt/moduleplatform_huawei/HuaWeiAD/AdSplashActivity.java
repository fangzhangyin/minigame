...
//            Toast.makeText(AdSplashActivity.this, getString(R.string.status_load_ad_success), Toast.LENGTH_SHORT).show();
        }
...
//            Toast.makeText(AdSplashActivity.this, getString(R.string.status_load_ad_fail) + errorCode, Toast.LENGTH_SHORT).show();
            jump();
        }
...
//            Toast.makeText(AdSplashActivity.this, getString(R.string.status_ad_dismissed), Toast.LENGTH_SHORT).show();
            jump();
        }
    };
    ...
    private void loadAd() {
        ...
        splashView.load(adId, ActivityInfo.SCREEN_ORIENTATION_PORTRAIT, adParam, splashAdLoadListener);
